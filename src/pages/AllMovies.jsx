...
const AllMovies = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10 ">
            ...
            <h2 className="text-3xl font-bold mb-2 text-center text-red-600">All Movies</h2>
            <p className="text-gray-500 mb-6 font-medium text-lg text-center">Discover the hottest movies everyone is talking about right now!</p>
